...
//change colours to gjengset ones
    ...
    IP: Send + 'static,
{
    ...
    let jh = std::thread::spawn(move || {
        ...
        for line in stdin.lines() {
            //listens for .send function in Message implementation
    ...
    for input in rx {
        //using a channel here so the program can commumicate with itself. instead of having
